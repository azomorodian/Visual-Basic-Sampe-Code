Public Class Form1
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        Dim res As Boolean
        res = Add_Marices(MatA, MatB, MatC)
        If res Then
            DisplayMatrix("A+B", MatC)
        Else
            ListBox1.Items.Add("Can't add to matrices with diffrent dimention")
        End If
    ...
    Sub DisplayMatrix(ByVal mName As String, ByVal mat(,) As Integer)
        ...
        ListBox1.Items.Add(str1)
    End Sub
    Function Add_Marices(ByVal a(,) As Integer, ByVal b(,) As Integer, ByRef c(,) As Integer) As Boolean
        Add_Marices = False
        If a.GetUpperBound(0) <> b.GetUpperBound(0) Or a.GetUpperBound(1) <> b.GetUpperBound(1) Then Exit Function
        ReDim c(a.GetUpperBound(0), a.GetUpperBound(1))
